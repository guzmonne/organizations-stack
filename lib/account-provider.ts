...
/**
 * AccountProvider is a Custom Resource provider capable of creating AWS Accounts
 */
export class AccountProvider extends NestedStack {
  ...
  private constructor(scope: Construct, id: string) {
     ...
     * Lambda
     */
    const code = lambda.Code.fromAsset(path.join(__dirname, "../lambda/account-handler"))
    /**
    ...
    /**
     * Custom AccountProvider resource.
     */

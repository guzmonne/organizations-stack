...
/**
 * PipelineProvider is a Custom Resource provider capable of creating Git Branches
 */
export class BranchProvider extends NestedStack {
  /**
   * Creates a stack-singleton resource provider nested stack.
   */
  public static getOrCreate(scope: Construct) {
    const stack = Stack.of(scope)
    const uid = "@aws-cdk/organizations.BranchProvider"
    return stack.node.tryFindChild(uid) as BranchProvider || new BranchProvider(stack, uid)
  }
  /**
   ...
   *
   * @param scope - The parent Construct instantiating this Git Branch
  ...
  private constructor(scope: Construct, id: string) {
     ...
     * Lambda
     */
    const code = lambda.Code.fromAsset(path.join(__dirname, "../lambda/branch-provider"))
    /**
     ...
     */
    this.provider = new cr.Provider(this, "BranchProvider", {

...
/**
 * onEventHandler creates a CDK pipeline pointing to a branch
 * @param event - An event with the following ResourceProperties:
 * @property event.pipelineName - Pipeline name
 * @property event.branch - Branch name
 * @returns A PhysicalResourceId corresponding to the CreatePipeline request's id necessary to
